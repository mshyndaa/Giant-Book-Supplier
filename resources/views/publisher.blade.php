        ...
        <div class="row row-cols-1 row-cols-md-3 g-4 m-3 ">
          ...
          <div class="col">  
            <div class="card h-100 w-75 text-bg-dark" style=" margin : auto;">
              <img src="{{url($p->image)}}" style="object-fit:cover; height:100;" class="card-img-top" alt="...">
              <div class="card-body">
              ...
              <div class="card-footer text-center">
                  <a href="/publisherdetail/{{$p->id}}" class=" border-top border-light btn btn-danger">More Detail</a>
            </div>
          </div>
           </div>
          @endforeach
