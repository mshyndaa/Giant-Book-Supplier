...
<body>
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4 m-3 ">
          ...
          <div class="col">  
            <div class="card h-100 w-75 text-bg-dark" style=" margin : auto;">
              <img src="<?php echo e(url($p->image)); ?>" style="object-fit:cover; height:100;" class="card-img-top" alt="...">
              <div class="card-body">
                <h5 class="card-title text-center"><?php echo e($p->name); ?></h5>
                <p class="card-text text-center">Giant Book Supplier</p>
                <h6 class="card-title text-center"></h6>
              </div>
              <div class="card-footer text-center">
                  <a href="/publisherdetail/<?php echo e($p->id); ?>" class=" border-top border-light btn btn-danger">More Detail</a>
            </div>
          </div>
           </div>
    ...
    <!--Footer-->
    <footer>
        <div class="footer text-center bg-dark text-bg-dark h-auto w-auto mt-3 position-sticky "style="align-items: center"   >
