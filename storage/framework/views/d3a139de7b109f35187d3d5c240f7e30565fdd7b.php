    ...
    <header>
     ...
     <div class=" navigation text-center ">
      <div class="card-header text-bg-secondary " style="height :  3rem">
       ...
       <!--Dropdown *Navigation Bar-->
          <li class="nav-item  ">
          <a class="btn dropdown-toggle fw-semibold text-light nav-link nav-pills  active  mt-1"  href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            Category
          </a>
     ...
     <div class="card border-dark mt-3 mb-3  " style="max-width: 1000px;">
        ...
        <div class="row row-cols-1 row-cols-md-4 g-4 m-3 ">
          ...
          <div class="col">  
            <div class="card h-100 w-90 text-bg-dark" style=" margin : auto;">
              ...
              <div class="card-footer text-center">
                  <a href="/bookdetail/<?php echo e($bk->id); ?>" class=" border-top border-light btn btn-danger">More Detail</a>
            </div>
          </div>
           </div>
...
</html><?php /**PATH C:\Users\mshyn\UTSWP2440027303\resources\views//category.blade.php ENDPATH**/ ?>